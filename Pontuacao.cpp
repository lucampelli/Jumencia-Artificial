    ...
    for (int i = 0; i < 15; i++) {
		...
		if(lastSymbol != 0){
            ...
            if (tabuleiro[i][j] == 1) {
                pontos1++;
                if (pontos2 > 0) {
                    soma2 += heuristicaS(espacosA, pontos2, espacosD, consec, seq1, seq2);
                    pontos2 = 0;
                    espacosA = espacosD;
                    espacosD = 0;
                }
		...
		consec++;
            ...
            if (tabuleiro[i][j] == 2) {
                pontos2++;
                if (pontos1 > 0) {
                    soma1 += heuristicaS(espacosA, pontos1, espacosD, consec, seq1, seq2);
                    pontos1 = 0;
                    espacosA = espacosD;
                    espacosD = 0;
                }
        ...
        if (pontos2 > 0) {
            soma1 += heuristicaS(espacosA, pontos2, espacosD, consec, seq1, seq2);
        }
        espacosD = 0;
        espacosA = 0;
        pontos1 = 0;
    ...
    for (int j = 0; j < 15; j++) {
		...
		if(lastSymbol != 0){
            ...
            if (tabuleiro[i][j] == 1) {
                pontos1++;
                if (pontos2 > 0) {
                    soma2 += heuristica(espacosA, pontos2, espacosD, consec);
                    pontos2 = 0;
                    espacosA = espacosD;
                    espacosD = 0;
                }
		...
		consec++;
            ...
            if (tabuleiro[i][j] == 2) {
                pontos2++;
                if (pontos1 > 0) {
                    soma1 += heuristica(espacosA, pontos1, espacosD, consec);
                    pontos1 = 0;
                    espacosA = espacosD;
                    espacosD = 0;
                }
        ...
        if (pontos2 > 0) {
            soma1 += heuristica(espacosA, pontos2, espacosD, consec);
        }
        espacosD = 0;
        espacosA = 0;
        pontos1 = 0;
...
int Pontuacao::heuristica(int espacosA, int pontos, int espacosD, int consec) {
...
int Pontuacao::heuristicaS(int espacosA, int pontos, int espacosD, int consec, int seq1[4], int seq2[4]) {
    //Aqui vou avaliar a situacao da ultima carreira de pedras e dar-lhes uma pontuacao
    //switchzao
    printf("Pontos: %i\n", pontos);
    printf("Espacos: %i\n", espacosA + espacosD);
